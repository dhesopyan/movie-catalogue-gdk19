 ...
 */
public class FavoriteTvFragment extends Fragment implements LoadNotesCallback{
    RecyclerView rvMovie;
    private MovieFavoriteAdapter movieAdapter;
    private FavoriteTvFragment.DataObserver myObserver;
    ...
    private static class getData extends AsyncTask<Void, Void, Cursor> {
        ...
        protected Cursor doInBackground(Void... voids) {
            ...
            favoriteHelper.open();
            return favoriteHelper.queryByTypeProvider("tv");
        }
    ...
    static class DataObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            new FavoriteTvFragment.getData(context, (LoadNotesCallback) this).execute();
        }
    }
